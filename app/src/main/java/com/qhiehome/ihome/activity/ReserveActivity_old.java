...
public class ReserveActivity_old extends BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reserve_old);
...
//            new LoadDataTask(groupOrdinal, mLvReserve, ReserveActivity_old.this).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
//        }
//    }
//
//    @Override
...
//        private final ReserveActivity_old mActivity;
//        private WeakReference<AsyncExpandableListView<String, Bitmap>> listviewRef = null;
//
//        public LoadDataTask(int groupOrdinal, AsyncExpandableListView<String, Bitmap> listview, ReserveActivity_old activity) {
...
//                CityConfigRequest cityConfigRequest = new CityConfigRequest(mActivity.mOrderBeanList.get(mGroupOrdinal).getEstate().getId());
...
//
//                            }else {
//                                ToastUtil.showToast(mActivity.mContext, "服务器繁忙，请稍后再试");
//                            }
//                        }catch (Exception e){
//                            e.printStackTrace();
//                            ToastUtil.showToast(mActivity.mContext, "服务器错误，请稍后再试");
//                        }
//
//                    }
//
...
//                        ToastUtil.showToast(mActivity.mContext, "网络连接异常");
//                    }
//                });
////            }
...
//        Intent intent = new Intent(context, ReserveActivity_old.class);
...
//        Intent intent = new Intent(ReserveActivity_old.this, PayActivity.class);
